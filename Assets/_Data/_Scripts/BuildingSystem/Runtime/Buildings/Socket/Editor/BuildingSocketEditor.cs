...
namespace DR.BuildingSystem.Features.Runtime.Buildings.Socket.Editor
{
                    ...
                    else if (Event.current.type == EventType.DragPerform)
                    {
                        for (int i = 0; i < DragAndDrop.objectReferences.Length; i++)
                        {
                            ...
                            if (!PrefabUtility.IsPartOfPrefabAsset(draggedObject))
                            {
                                ...
                                {
                                    Debug.LogError("<b>Building System</b> The object does not have a Building Part component or the prefab is not the original.");
                                    return;
                                }
                            }
                            ...
                            {
                                Debug.LogError("<b>Building System</b> The object is missing the Building Part component!");
                                return;
                            }

                            if (!BuildingManager.Instance.BuildingPartReferences.Contains(draggedBuildingPart))
                            {
                                Debug.LogError("<b>Building System</b> The Building Part reference does not exist in the Building Manager!");
                                return;
                            }
