...
namespace DR.BuildingSystem.Features.Runtime.Buildings.Part.Editor
{
            ...
            if (Application.isPlaying)
            {
                ...
                if (GUILayout.Button("Apply All Changes..."))
                {
                    ...
                    if (buildingPart != null)
                    {
                        ...
                        Debug.Log("<b>Building System</b> All changes to the Building Part \"" + buildingPart.GetGeneralSettings.Name + "\" have been applied.");
                    }
                }
            }
                ...
                if (Target.GetModelSettings.Models != null)
                {
                    ...
                    if (GUILayout.Button("Add MeshCollider(s)..."))
                    {
                        foreach (Renderer renderer in Target.gameObject.GetComponentsInChildren<Renderer>())
                        {
                            ...
                            Debug.Log("<b>Building System</b> The missing collider(s) have been added to the renderer(s) successfully.");
                        }
                    }
                }
            }
                ...
                if (dropRect.Contains(Event.current.mousePosition))
                {
                    ...
                    else if (Event.current.type == EventType.DragPerform)
                    {
                        for (int i = 0; i < DragAndDrop.objectReferences.Length; i++)
                        {
                            ...
                            {
                                Debug.LogError("<b>Building System</b> Cannot add empty gameObject!");
                                return;
                            }
    ...
    public class ModelOffsetEditor : EditorWindow
    {
        ...
        static void WindowContent(int id)
        {
            ...
            EditorGUIUtilityExtension.DrawHeader("Building System - Model Offset Editor",
