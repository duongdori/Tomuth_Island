...
namespace DR.BuildingSystem.Features.Editor.Window
{
    public class PackageImporter : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUIUtilityExtension.DrawHeader("Building System - Package Importer",
            ...
            {
                if (EditorUtility.DisplayDialog("Building System - Import Package",
        ...
        public static IEnumerator InstallSupports(bool installXR)
        {
            ...
            {
                Debug.Log("<b>Building System</b> New Input System support has been successfully installed!");
            });
            ...
            if (installXR)
            {
                ...
                {
                    Debug.Log("<b>Building System</b> XR Interaction Toolkit support has been successfully installed!");
                });
            }
