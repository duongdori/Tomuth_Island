...
namespace DR.BuildingSystem.Features.Editor.Window
{
    public class IntegrationManager : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUIUtilityExtension.DrawHeader("Building System - Integration Manager",
                "Integration Manager allows you to import integrations that work with Building System.\n" +
