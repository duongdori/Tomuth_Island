...
using DR.BuildingSystem.Features.Runtime.Buildings.Socket;
...
namespace DR.BuildingSystem.Features.Editor
{
    ...
    {
        [MenuItem(@"Tools/Building System/Package Importer...", priority = -10000)]
        public static void PackageImporter()
        {
            Window.PackageImporter.Init();
        }

        [MenuItem(@"Tools/Building System/Integration Manager...", priority = -10000)]
        public static void IntegrationManager()
        {
            Window.IntegrationManager.Init();
        }

        [MenuItem("GameObject/Building System/Tools/Components/Create Building Manager...", priority = -1000)]
        [MenuItem(@"Tools/Building System/Tools/Components/Create Building Manager...", priority = -1000)]
        public static void CreateBuildingManager()
        {
            ...
            Debug.Log("<b>Building System</b> The Building Manager component has been successfully created!");
        }

        [MenuItem("GameObject/Building System/Tools/Components/Create Building Saver...", priority = -1000)]
        [MenuItem(@"Tools/Building System/Tools/Components/Create Building Saver...", priority = -1000)]
        public static void CreateBuildingSaver()
        {
            ...
            Debug.Log("<b>Building System</b> The Building Saver component has been successfully created!");
        }

        [MenuItem("GameObject/Building System/Tools/Components/Create Building Area...", priority = -1000)]
        [MenuItem(@"Tools/Building System/Tools/Components/Create Building Area...", priority = -1000)]
        public static void CreateBuildingArea()
        {
            ...
            Debug.Log("<b>Building System</b> The Building Area component has been successfully created!");
        }

        [MenuItem("GameObject/Building System/Tools/Components/Create Building Part...", priority = -1000)]
        [MenuItem(@"Tools/Building System/Tools/Components/Create Building Part...", priority = -1000)]
        public static void CreateBuildingPart()
        {
            if (Selection.gameObjects.Length == 0)
            {
                Debug.LogWarning("<b>Building System</b> : Please select the gameObject to create a new Building Part.");
                return;
            }
            ...
            for (int i = 0; i < Selection.gameObjects.Length; i++)
            {
                ...
                {
                    string localPath =
                        EditorUtility.SaveFilePanelInProject("Building System - Define a save path...",
                    ...
                    if (localPath != string.Empty)
                    {
                        ...
                        if (BuildingManager.Instance != null)
                        {
                            ...
                            Debug.Log("<b>Building System</b> : The Building Part '" + buildingPart.name + "' has been added to Building Manger.");
        ...
        [MenuItem("GameObject/Building System/Tools/Components/Create Building Socket...", priority = -1000)]
        [MenuItem(@"Tools/Building System/Tools/Components/Create Building Socket...", priority = -1000)]
        public static void CreateBuildingSocket()
        {
            ...
            Debug.Log("<b>Building System</b> The Building Socket component has been successfully created!");
        }

        [MenuItem("GameObject/Building System/Tools/Scriptable Objects/Create Building Collection...", false, priority = -200)]
        [MenuItem(@"Tools/Building System/Tools/Scriptable Objects/Create Building Collection...", priority = -200)]
        public static void CreateBuildingCollection()
        {
            ...
            Debug.Log("<b>Building System</b> The Building Collection component has been successfully created!");
        }

        [MenuItem("Tools/Building System/Tools/Building Placer Editor...", priority = -100)]
        public static void EditorBuildingPlacer()
        {
            if (BuildingManager.Instance == null)
            {
                Debug.LogWarning("<b>Building System</b> The scene is not set up. Please ensure the setup is completed.");
                return;
            }

            if (Application.isPlaying)
            {
                Debug.LogWarning("<b>Building System</b>: The Building Placer Editor cannot be used during runtime!");
                return;
            }

            GameObject buildingPlacerObject = new GameObject("Building System - Building Placer Editor");
            buildingPlacerObject.AddComponent<InspectorBuildingPlacer>();

            Selection.activeObject = buildingPlacerObject;
        }

        [MenuItem(@"Tools/Building System/Utilities/Scene Setup...", priority = -100)]
        public static void SceneSetup()
        {
            if (Camera.main == null)
            {
                Debug.LogWarning("<b>Building System</b> Main Camera not found. Please ensure that you have a camera tagged as 'MainCamera'.");
            ...
            {
                Debug.LogWarning("<b>Building System</b> The scene has already been set up!");
                return;
            }
            ...
            Debug.Log("<b>Building System</b> Scene setup successful!");
        }

        [MenuItem(@"Tools/Building System/Support...")]
        public static void SupportLink()
        {
            Application.OpenURL("https://form.jotform.com/202960719544359");
        }

        [MenuItem(@"Tools/Building System/Documentation...")]
